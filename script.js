...
BtnAllusers.addEventListener("click", () => {
  ...
  axios
    .get("https://herokuexpresscrud.herokuapp.com/users")
    .then((response) => {
...
Btncreate.addEventListener("click", () => {
  ...
  const URL = "https://herokuexpresscrud.herokuapp.com/user";
...
Btnuser.addEventListener("click", () => {
  ...
  document.getElementById("tbod").textContent = ""
  axios
    .get(`https://herokuexpresscrud.herokuapp.com/user/${InpgetUser}`)
    .then((response) => {
      //console.log(response.data);
...
BtnEdit.addEventListener("click", () => {
  ...
  axios
    .put(`https://herokuexpresscrud.herokuapp.com/user/${editid}`, {
      name: editNam,
      email: editEmai,
      address: editAddr,
    })
...
BtnDel.addEventListener("click", () => {
  ...
  axios
    .delete(`https://herokuexpresscrud.herokuapp.com/user/${DeleID}`)
    .then((response) => {
...
BtnDelAll.addEventListener("click", () => {
  axios
    .delete("https://herokuexpresscrud.herokuapp.com/userdelall")
    .then((response) => {
